...
@.str = private unnamed_addr constant [24 x i8] c"Que opcion deseas hacer\00", align 1
@.str.1 = private unnamed_addr constant [10 x i8] c"1-Circulo\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"2-Triangulo\00", align 1
@.str.3 = private unnamed_addr constant [13 x i8] c"3-Rectangulo\00", align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str.4 = private unnamed_addr constant [41 x i8] c"opcion para calcular la area del circulo\00", align 1
@.str.5 = private unnamed_addr constant [29 x i8] c"Ingrese el radio del circulo\00", align 1
@.str.6 = private unnamed_addr constant [25 x i8] c"El area del circulo es: \00", align 1
@.str.7 = private unnamed_addr constant [43 x i8] c"opcion para calcular la area del triangulo\00", align 1
@.str.8 = private unnamed_addr constant [30 x i8] c"Ingrese la base del triangulo\00", align 1
@.str.9 = private unnamed_addr constant [32 x i8] c"Ingrese la altura del triangulo\00", align 1
@.str.10 = private unnamed_addr constant [27 x i8] c"El area del triangulo es: \00", align 1
@.str.11 = private unnamed_addr constant [44 x i8] c"opcion para calcular la area del rectangulo\00", align 1
@.str.12 = private unnamed_addr constant [31 x i8] c"Ingrese la base del rectangulo\00", align 1
@.str.13 = private unnamed_addr constant [33 x i8] c"Ingrese la altura del rectangulo\00", align 1
@.str.14 = private unnamed_addr constant [28 x i8] c"El area del rectangulo es: \00", align 1
@.str.15 = private unnamed_addr constant [16 x i8] c"Opcion invalida\00", align 1
...
define dso_local noundef i32 @main() #0 {
  ...
  store double 3.141600e+00, ptr %7, align 8
...
18:                                               ; preds = %0
  ...
  %32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.6)
...
36:                                               ; preds = %0
  %37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.7)
  ...
  %39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.8)
...
53:                                               ; preds = %0
  %54 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.11)
  ...
  %59 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.13)
  ...
  %65 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.14)
...
69:                                               ; preds = %0
  %70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.15)
