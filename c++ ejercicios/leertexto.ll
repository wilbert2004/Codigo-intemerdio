; ModuleID = 'leertexto.cpp'
source_filename = "leertexto.cpp"
...
@.str = private unnamed_addr constant [30 x i8] c"Ingresa el numero por favor: \00", align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str.1 = private unnamed_addr constant [36 x i8] c"la suma del total del digitos es : \00", align 1
